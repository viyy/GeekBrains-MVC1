...
namespace WebStore.ServicesHosting.Controllers
{
    ...
    public class UsersApiController : Controller
    {
        ...
        public UsersApiController(WebStoreContext context) => _userStore = new UserStore<User>(context)
        {
        ...
        public async Task SetUserNameAsync([FromBody] User user, string userName) => await _userStore.SetUserNameAsync(user, userName);
        ...
        public async Task SetNormalizedUserNameAsync([FromBody] User user, string normalizedName) => await _userStore.SetNormalizedUserNameAsync(user, normalizedName);
        ...
        public async Task<User> FindByNameAsync(string normalizedUserName) => await _userStore.FindByNameAsync(normalizedUserName);
        ...
        [HttpPost("addClaims")]
        public async Task AddClaimsAsync([FromBody] AddClaimsDto claimsDto) => await _userStore.AddClaimsAsync(claimsDto.User, claimsDto.Claims);

        [HttpPost("replaceClaim")]
        public async Task ReplaceClaimAsync([FromBody] ReplaceClaimsDto claimsDto) => await _userStore.ReplaceClaimAsync(claimsDto.User, claimsDto.Claim, claimsDto.NewClaim);

        [HttpPost("removeClaims")]
        public async Task RemoveClaimsAsync([FromBody] RemoveClaimsDto claimsDto) => await _userStore.RemoveClaimsAsync(claimsDto.User, claimsDto.Claims);
        ...
        public async Task SetTwoFactorEnabledAsync([FromBody] User user, bool enabled) => await _userStore.SetTwoFactorEnabledAsync(user, enabled);
        ...
        public async Task SetEmailConfirmedAsync([FromBody] User user, bool confirmed) => await _userStore.SetEmailConfirmedAsync(user, confirmed);

        [HttpGet("user/findByEmail/{normalizedEmail}")]
        public async Task<User> FindByEmailAsync(string normalizedEmail) => await _userStore.FindByEmailAsync(normalizedEmail);
        ...
        public async Task SetNormalizedEmailAsync([FromBody] User user, string normalizedEmail) => await _userStore.SetNormalizedEmailAsync(user, normalizedEmail);

        [HttpPost("setPhoneNumber/{phoneNumber}")]
        public async Task SetPhoneNumberAsync([FromBody] User user, string phoneNumber) => await _userStore.SetPhoneNumberAsync(user, phoneNumber);
        ...
        public async Task SetPhoneNumberConfirmedAsync([FromBody] User user, bool confirmed) => await _userStore.SetPhoneNumberConfirmedAsync(user, confirmed);
        ...
        public async Task RemoveLoginAsync([FromBody] User user, string loginProvider, string providerKey) => await _userStore.RemoveLoginAsync(user, loginProvider, providerKey);
        ...
        public Task SetLockoutEndDateAsync(SetLockoutDto setLockoutDto) => _userStore.SetLockoutEndDateAsync(setLockoutDto.User, setLockoutDto.LockoutEnd);

        [HttpPost("IncrementAccessFailedCount")]
        public async Task<int> IncrementAccessFailedCountAsync(User user) => await _userStore.IncrementAccessFailedCountAsync(user);

        [HttpPost("ResetAccessFailedCount")]
        public Task ResetAccessFailedCountAsync(User user) => _userStore.ResetAccessFailedCountAsync(user);

        [HttpPost("GetAccessFailedCount")]
        public async Task<int> GetAccessFailedCountAsync(User user) => await _userStore.GetAccessFailedCountAsync(user);
        ...
        public async Task SetLockoutEnabledAsync(User user, bool enabled) => await _userStore.SetLockoutEnabledAsync(user, enabled);
    }
}