...
(function(e, t) {
    ...
    x.fn = x.prototype = {
        ...
        init: function(e, n, r) {
            ...
            if ("string" == typeof e) {
                ...
                if (i[1]) {
                    if (n =
                            n instanceof x ? n[0] : n, x.merge(this,
        ...
        isPlainObject: function(e) {
            ...
            try {
                if (e.constructor &&
                    ...
                    !v.call(e.constructor.prototype, "isPrototypeOf")) return!1
            } catch (r) {
                return!1
            }
    ...
    r = x(a), function(e, t) {
        ...
        function at(e, t, n, i) {
            ...
            if ((t ? t.ownerDocument || t : w) !== f && p(t), t = t || f, n =
        ...
        s = at.isXML = function(e) {
            ...
            return n !== f && 9 === n.nodeType && n.documentElement
                ? (f = n, d = n.documentElement, h =
                        !s(n), i && i.attachEvent && i !== i.top && i.attachEvent("onbeforeunload", function() { p() }),
                    r.attributes =
                        ut(function(e) { return e.className = "i", !e.getAttribute("className") }), r
                    ...
                    (ut(function(e) {
                        ...
                        t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("t", ""),
                            ...
                            K.test(y = d.webkitMatchesSelector ||
                        ...
                        g.length && RegExp(g.join("|")), m = m.length && RegExp(m.join("|")), v =
        ...
        function vt(e, t, n) {
            ...
            return t.first
                ? function(t, n, i) { while (t = t[r]) if (1 === t.nodeType || o) return e(t, n, i) }
                : function(t, n, s) {
                    var l, u, c, p = T + " " + a;
                    if (s) {
            ...
            for (; i > l; l++)
                if (n = o.relative[e[l].type]) f = [vt(bt(f), n)];
                    ...
                    if (n = o.filter[e[l].type].apply(null, e[l].matches), n[b]) {
                        ...
                        return wt(l > 1 && bt(f),
                            l > 1 &&
                            yt(e.slice(0, l - 1).concat({ value: " " === e[l - 2].type ? "*" : "" })).replace(z, "$1"),
                            n,
                            r > l && Tt(e.slice(l, r)),
                            i > r && Tt(e = e.slice(r)),
                            i > r && yt(e))
        ...
        r.sortStable = b.split("").sort(A).join("") === b, r.detectDuplicates = S, p(), r.sortDetached =
                ut(function(e) { return 1 & e.compareDocumentPosition(f.createElement("div")) }),
            ut(function(e) { return e.innerHTML = "<a href='#'></a>", "#" === e.firstChild.getAttribute("href") }) ||
                ct("type|href|height|width",
                    function(e, n, r) { return r ? t : e.getAttribute(n, "type" === n.toLowerCase() ? 1 : 2) }),
            r.attributes &&
                ut(function(e) {
                    return e.innerHTML =
                ...
                ct("value",
                    function(e, n, r) { return r || "input" !== e.nodeName.toLowerCase() ? t : e.defaultValue }),
                ...
                ct(B,
                    function(e, n, r) {
                        ...
                        return r
                            ...
                            ? n.toLowerCase()
                            : null
                    }), x.find = at, x.expr = at.selectors, x.expr[":"] = x.expr.pseudos, x.unique =
                at.uniqueSort, x.text =
    ...
    x.Callbacks = function(e) {
        ...
        if (d.setAttribute("className", "t"), d.innerHTML =
            ...
            d.getElementsByTagName("a")[0], !r || !r.style || !n.length) return t;
    ...
    x.fn.extend({
            ...
            hasClass: function(e) {
                ...
                for (; r > n; n++)
                    if (1 === this[n].nodeType &&
                        (" " + this[n].className + " ").replace(U, " ").indexOf(t) >= 0) return!0;
                return!1
            },
            val: function(e) {
                var n, r, i, o = this[0];
        ...
        (x.propHooks.selected = {
            ...
            function() { x.propFix[this.toLowerCase()] = this }), x.support.enctype || (x.propFix.enctype = "encoding"),
        x.each(
            ["radio", "checkbox"],
            function() {
                x.valHooks[this] =
    ...
    (x.event.special.change = {
        ...
        on: function(e, n, r, i, o) {
            ...
            if (null == r && null == i
                ? (i = n, r = n = t)
                : null == i && ("string" == typeof n ? (i = r, r = t) : (i = r, r = n, n = t)), i === !1) i = ot;
        ...
        clone: function(e, t, n) {
            ...
            if (x.support.html5Clone || x.isXMLDoc(e) || !mt.test("<" + e.nodeName + ">")
                ...
                x.support.noCloneEvent && x.support.noCloneChecked ||
                    ...
                    x.isXMLDoc(e))) for (r = Ft(o), s = Ft(e), a = 0; null != (i = s[a]); ++a) r[a] && Ot(i, r[a]);
            if (t)
    ...
    x.fn.extend({
        ...
        toggle: function(e) {
            return"boolean" == typeof e
                ...
                ? this.show()
                : this.hide()
                : this.each(function() { nn(this) ? x(this).show() : x(this).hide() })
        }
    }), x.extend({
        cssHooks: {
            opacity: {
        ...
        style: function(e, n, r, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (n = x.cssProps[l] || (x.cssProps[l] = tn(u, l)), s =
                    x.cssHooks[n] || x.cssHooks[l], r === t)
    ...
    x.fn.extend({
        ...
        if (n === t && (n = x.ajaxSettings && x.ajaxSettings.traditional), x.isArray(e) ||
            e.jquery && !x.isPlainObject(e)) x.each(e, function() { o(this.name, this.value) });
                ...
                return{
                    send: function(i, o) {
                        ...
                        if (n.username
                            ...
                            : l.open(n.type, n.url, n.async), n.xhrFields) for (s in n.xhrFields) l[s] = n.xhrFields[s];
        ...
        Qn = {
            "*": [
                function(e, t) {
                    ...
                    return i &&
                        (a = n.start = +a || +r || 0, n.unit = o, n.end = i[1] ? a + (i[1] + 1) * i[2] : +i[2]), n
                }
            ]
        };
    ...
    function nr(e, t, n) {
        ...
        n.queue ||
            ...
            u.always(
                function() { u.always(function() { s.unqueued--, x.queue(e, "fx").length || s.empty.fire() }) })),
            1 === e.nodeType &&
    ...
    x.each({
            ...
            }, x.easing =
        {
            ...
            function() { clearInterval(Un), Un = null }, x.fx.speeds =
            { slow: 600, fast: 200, _default: 400 }, x.fx.step =
            {}, x.expr &&
            x.expr.filters &&
            (x.expr.filters.animated = function(e) {
                return x.grep(x.timers, function(t) { return e === t.elem }).length
            }),
